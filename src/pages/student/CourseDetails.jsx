...
const CourseDetails = () => {
  ...
  const { currency, calculateChapterTime, calculateCourseDuration, calculateRating, calculateNoOfLectures } = useContext(AppContext)

  useEffect(() => {
    const selectedCourse = dummyCourses.find(course => course._id === id)
